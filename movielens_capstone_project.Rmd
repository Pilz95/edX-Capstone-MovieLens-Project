...
```
The final RMSE with matrix factorization is `r {toString(round(model_5_rmse, 5))}`. It is a bit higher then the RMSE we previously reported for the `edx_validation_set`, but this is very common for machine learning. This RMSE fulfills the specified criterion.
